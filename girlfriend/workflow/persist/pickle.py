...
class PicklePersistListener(AbstractListener):
    ...
    def on_unit_start(self, context):
        ...
        if context.thread_id is None:
            ...
            context.logger.debug(
                "Pickle dump ignore '{}'.".format(context.current_unit))
    ...
    def _dump_context(self, context, status):
        pickle.dump({
            ...
            "status": status
        }, open(self._dump_to, "w"))


class PickleRecoverPolicy(RecoverPolicy):
    ...
    def load(self):
        ...
        dumped_data = pickle.load(open(self._recover_from, "r"))
